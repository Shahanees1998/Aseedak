        ...
        <LayoutContext.Provider value={value}>
            <>
                <Head>
                    ...
                    <meta
                        name="description"
                        content="Multiplayer word-based elimination game where players guess words to eliminate targets"
                    />
                    ...
                    <meta
                        property="og:title"
                        content="Aseedak - Word Elimination Game"
                    ></meta>
                    <meta
                        property="og:url"
                        content="https://aseedak.com"
                    ></meta>
                    <meta
